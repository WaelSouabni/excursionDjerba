...
We created [WP Travel Engine, a travel WordPress plugin](https://wptravelengine.com/?utm_source=free_plugin&utm_medium=wporg&utm_campaign=upgrade_to_pro), to help every travel website owner to create travel and tour booking websites quickly, and increase bookings, inquiries and Average Order Value (AOV).
...
#### Marketing
* **[Partial Payment](https://wptravelengine.com/plugins/partial-payment/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — You can set an upfront payment (percentage or fixed amount) to tours. Guests can make some amount upfront while booking a tour and the remaining amount later.
* **[User History](https://wptravelengine.com/plugins/user-history/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — This add-on will help you keep track of your guests' booking journey so that you can see which pages they visited before booking and how much time they spent on each page. You can use this information to make informed decisions about how to build more trust and influence the booking decision.
...
* **[File Downloads](https://wptravelengine.com/plugins/file-downloads/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — You can add downloadable files to trips for guests to download. Guests can provide an email address (optional) to receive the downloadable file. In addition, you can capture leads by requiring an email address to download the files.

#### Conversion
* **[Legal Documents](https://wptravelengine.com/plugins/legal-documents/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — Allows you to add physical and legal documents to the site. Display them on pages, posts, or widgets using shortcodes for users to view or download.
* **[Trip Reviews](https://wptravelengine.com/plugins/trip-reviews/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — Allows guests to leave a review on the website. It helps build trust among the guests and also helps increase bookings.
...
* **[Social Proof](https://wptravelengine.com/plugins/social-proof/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro&utm_id=wporg)** — It leverages social proof to increase the conversion by letting your guests know that others have bought trips from you. Research shows that social proof can increase conversion.
...
WP Travel Engine provides various [shortcodes](https://wptravelengine.com/shortcodes/?utm_source=free_plugin&utm_medium=wporg&utm_campaign=documentation) that you can use to display trips and itineraries, destinations, activities and so on.
